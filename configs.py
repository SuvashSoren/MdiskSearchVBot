...
class Config(object):
    ...
    CHANNEL_ID = int(os.getenv("CHANNEL_ID", "-1001602033957")) 
...
Mᴀᴅᴇ Wɪᴛʜ ❤️ Bʏ - @SubasSoren

Jᴜsᴛ Tʏᴘᴇ ᴀ Mᴏᴠɪᴇ Nᴀᴍᴇ 🎬**""" ) 
    START_PHOTO = os.getenv("START_PHOTO", "https://telegra.ph/file/28fc1ad0fe623265c4dfb.jpg")
...
ꜰᴏʀ ᴍᴏʀᴇ ɪɴꜰᴏ ᴄʟɪᴄᴋ ᴏɴ ʜᴇʟᴘ ✅""" )
    ...
    UPDATES_CHANNEL_USERNAME = os.getenv("UPDATES_CHANNEL_USERNAME", "FILMY_Update_Official")
    FORCE_SUB = os.getenv("FORCE_SUB", "true")
    AUTO_DELETE_TIME = int(os.getenv("AUTO_DELETE_TIME", 180))
    MDISK_API = os.getenv("MDISK_API", "QqTaWUfW4gRZiwHu4cdg")
...
https://terabox.com/s/1VB4TLcOygLQ-NQlGV0QLKA
